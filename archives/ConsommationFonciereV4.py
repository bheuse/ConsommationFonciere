...
configurationFile    = input_dir  + "ConfigurationV4.xlsx"
...
def load_sitadel(sitadel1316_file:  str = sitadel1316File,
    ...
    if (sitadel1316 is None) or (sitadel1721 is None)  or (sitadelMeta is None):
        ...
        sitadel1721 = pd.read_csv(sitadel1721_file, delimiter=';', index_col=4, encoding='latin-1', dtype={"DEP": str, "COMM": str, "Etat_DAU": str, "DPC_AUT": str, "ADR_LOCALITE_TER" : str, "ADR_CODPOST_TER" : str, "NATURE_PROJET_DECLAREE" : str, "I_EXTENSION": str, "I_SURELEVATION": str, "I_NIVSUPP": str, "Type_DAU": str, "Num_DAU": str, "SIREN_DEM": str, "SIRET_DEM": str, "CODPOST_DEM": str })
...
evolution220914 = None
evolution221419 = None
evolution221922 = None
...
def load_evolution22(evolution22_file: str = evolution22File):
    ...
    if (evolution220914 is None) or (evolution221419 is None)  or (evolution221419 is None):
        print_blue("Lecture Evolution Dept : " + evolution22_file + " ...")
...
def load_flux_2019(p_flux2019SourceFile:  str = flux2019SourceData):
    global flux2019
    if (flux2019 is None) :
        print_blue("Lecture Flux Mobilite Residentielle 2019 : " + p_flux2019SourceFile + " ...")
        flux2019 = pd.read_csv(p_flux2019SourceFile, delimiter=';', dtype={'CODGEO': str, 'LIBGEO': str,
...
def load_fluxpro_2019(p_fluxpro2019SourceFile:  str = fluxpro2019SourceData):
    global fluxpro2019
    if (fluxpro2019 is None) :
        print_blue("Lecture Flux Mobilite Domicile Travail 2019 : " + p_fluxpro2019SourceFile + " ...")
        fluxpro2019 = pd.read_csv(p_fluxpro2019SourceFile, delimiter=';', dtype={'CODGEO': str, 'LIBGEO': str,
                                                                         'DCRAN': str, 'L_DCRAN': str,
                                                                         'NBFLUX_C18_POP01P' : float})
    return fluxpro2019
...
def excel_flux():
    ...
    excel_flux_details(flux2019, "NBFLUX_C19_POP01P" , "93", 'Flux2019-93.xlsx')
