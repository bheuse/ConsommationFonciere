...
function f_val(val, format = "+") {
        if (format.includes("+") && (val>0)) return ("+"+val.toString())
        return ""+val.toString();
}
...
vm.component('table-stat', {
  ...
  template: `
        ...
        <table class="w3-table-all w3-hoverable w3-card-4">
            ...
            <tr class="w3-teal">
                <th>Donnees Sitadel / SRU</th>
                <th class="w3-right-align w3-blue-grey">Sitadel</th>
                <th class="w3-right-align w3-blue-grey">2013-2016</th>
                <th class="w3-right-align w3-blue-grey">2017-2021</th>
                <th class="w3-right-align w3-amber">2017-2021</th>
