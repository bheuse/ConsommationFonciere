...
const vm = Vue.createApp({
    ...
    methods : {
        ...
        updateChildren(){
           ...
           this.$refs.CalculetteEvolTailleMenages.update(this.ds.TM_2020, 2020, this.ds.TM_2030, 2030, this.ds.TXTM_1319);
           this.$refs.CalculetteTauxTailleMenages.update(this.ds.TM_2020, 2020, this.ds.TM_2030, 2030, this.ds.TXTM_1319);
    ...
    methods : {
        ...
        recalc(){
            ...
            if (this.loaded ==0 ) {
                ...
                this.scen0.evol_pop = this.ds.TXPOP_1319
                this.scen0.evol_tm  = this.ds.txtmen_1319
                this.scen0.lutte_secondaire = 0
                this.scen0.lutte_vacance = 0
                this.scen0.evol_pop = this.ds.TXPOP_1319
                this.scen0.evol_tm  = this.ds.txtmen_1319
    ...
    methods : {
        ...
        recalc(){
            ...
            if (this.loaded ==0 ) {
                ...
                this.scen1.evol_pop = this.ds.TXPOP_1319
                this.scen1.evol_tm  = this.ds.txtmen_1319
                this.loaded = 1
            }
            this.dataset = run_calculs(this.dataset)
        },
    ...
    <div  v-if="this.dataset != null">
        ...
        <table class="w3-table-all w3-hoverable w3-card-4">
            ...
            <tr class="w3-teal">
                ...
                <th class="w3-right-align w3-grey">5 ans</th>
                <th class="w3-right-align w3-teal">2019</th>
            ...
            <tr>
                ...
                <td class="w3-right-align">{{this.ds.f_epop_1319}}</td>
                <td class="w3-right-align">{{this.ds.pop_2019}}</td>
                <td class="w3-right-align">{{this.ds.f_epop_1920}}</td>
            ...
            <tr>
                ...
                <td class="w3-right-align"></td>
                <td class="w3-right-align">{{this.ds.f_etxpop_1319}}</td>
                <td class="w3-right-align"></td>
                <td class="w3-right-align">{{this.ds.f_etxpop_1920}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align"></td>
                <td class="w3-right-align">{{this.ds.pmen_2019}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align"></td>
                <td class="w3-right-align">{{this.ds.men_2019}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align">{{this.ds.f_txtmen_1319}}</td>
                <td class="w3-right-align">{{this.ds.f_tmen_2019}}</td>
                <td class="w3-right-align">{{this.ds.f_txtmen_1920}}</td>
            ...
            <tr>
                ...
                <td class="w3-right-align"></td>
                <td class="w3-right-align">{{this.ds.hmen_2019}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align"></td>
                <td class="w3-right-align">{{this.ds.f_txhmen_2019}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align">{{this.ds.f_rp_1319}}</td>
                <td class="w3-right-align">{{this.ds.f_rp_2019}}</td>
                <td class="w3-right-align">{{this.ds.f_rp_1920 }} </td>
            ...
            <tr>
                ...
                <td class="w3-right-align">{{this.ds.f_rs_1319}}</td>
                <td class="w3-right-align">{{this.ds.f_rs_2019}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align">{{this.ds.f_rv_1319}}</td>
                <td class="w3-right-align">{{this.ds.f_rv_2019}}</td>
                <td class="w3-right-align"></td>
            ...
            <tr>
                ...
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.f_log_1319}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.log_2019}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.f_log_1920}}</td>
            ...
            <tr>
                ...
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> </td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.f_conso_1319}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> </td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.f_conso_1920}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> </td>
            ...
            <tr class="w3-teal">
                ...
                <th class="w3-right-align w3-blue-grey">2017-2022</th>
                <th class="w3-right-align w3-orange">2017-2022</th>
                <th class="w3-right-align w3-orange">2013-2022</th>
            ...
            <tr>
                ...
                <td class="w3-right-align"> {{this.ds.sit_saut_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_eaut_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_eaut_13PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_eaut_1320}}</td>
                <td class="w3-right-align"> {{ Math.round(this.ds.sit_eaut_13PL / this.ds.scen_log_ha) }} ha</td>
            ...
            <tr>
                ...
                <td class="w3-right-align" > {{this.ds.sit_scom_17PL}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.sit_ecom_17PL}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.sit_ecom_13PL}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.sit_ecom_1320}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{Math.round(this.ds.sit_ecom_13PL/ this.ds.scen_log_ha) }} ha</td>
            ...
            <tr>
                ...
                <td class="w3-right-align"> {{this.ds.sit_f_stxr_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_f_etxr_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_f_etxr_13PL}}</td>
            ...
            <tr>
                ...
                <td class="w3-right-align"> {{this.ds.sit_scan_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ecan_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ecan_13PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ecan_1320}}</td>
                <td class="w3-right-align"> {{Math.round(this.ds.sit_ecan_13PL/ this.ds.scen_log_ha) }} ha</td>
            ...
            <tr> <!-- lcon_1316 ebes_1316 excd_1316 erps_1316 naff_1316 -->
                ...
                <td class="w3-right-align"> </td>
                <td class="w3-right-align"> {{this.ds.sit_lcon_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_lcon_13PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_lcon_1320}}</td>
                <td class="w3-right-align"> {{Math.round(this.ds.sit_lcon_13PL/ this.ds.scen_log_ha) }} ha</td>
            ...
            <tr>
                ...
                <td class="w3-right-align"> </td>
                <td class="w3-right-align"> {{this.ds.sit_ebes_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ebes_13PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ebes_1320}}</td>
                <td class="w3-right-align"> {{Math.round(this.ds.sit_ebes_13PL/ this.ds.scen_log_ha) }} ha</td>
            ...
            <tr>
                ...
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> </td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.sit_excd_17PL}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.sit_excd_13PL}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{this.ds.sit_excd_1320}}</td>
                <td class="w3-right-align" style="text-shadow:1px 1px 0 #444"> {{Math.round(this.ds.sit_excd_13PL/this.ds.scen_log_ha) }} ha</td>
            ...
            <tr>
                ...
                <td class="w3-right-align"> </td>
                <td class="w3-right-align"> {{this.ds.sit_ersv_17PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ersv_13PL}}</td>
                <td class="w3-right-align"> {{this.ds.sit_ersv_1320}}</td>
                <td class="w3-right-align"> {{Math.round(this.ds.sit_ersv_13PL/ this.ds.scen_log_ha) }} ha</td>
            ...
            <tr>
                ...
                <td class="w3-right-align w3-tooltip"> {{this.ds.sit_naff_17PL}}</td>
                <td class="w3-right-align w3-tooltip"> {{this.ds.sit_naff_13PL}}</td>
                <td class="w3-right-align w3-tooltip"> {{this.ds.sit_naff_1320}}</td>
                <td class="w3-right-align w3-tooltip"> {{Math.round(this.ds.sit_naff_13PL/ this.ds.scen_log_ha) }} ha</td>
...
function chartRepartitionNouveauxLogements(ds, container) {
    ...
    // Répartition des nouveaux Logements de 2008 a 2019
    $('#'+container).html('');
    if (ds=== null) { return ; }

    var data = google.visualization.arrayToDataTable([
      ['Evolution du parc entre 2008 et 2019 selon ses composants sur ' + ds.LIBELLE, 'Logements'],
      ['Nouvelles Résidences Principales', (ds.P19_RP      - ds.P08_RP>0)      ? (ds.P19_RP - ds.P08_RP) : 0],
      ['Nouvelles Résidences Secondaires', (ds.P19_RSECOCC - ds.P08_RSECOCC>0) ? (ds.P19_RSECOCC - ds.P08_RSECOCC) : 0],
      ['Nouveaux Logements Vacants',       (ds.P19_LOGVAC  - ds.P08_LOGVAC>0)  ? (ds.P19_LOGVAC - ds.P08_LOGVAC) : 0 ]
    ]);

    var options = {
      title:'Evolution du parc entre 2008 et 2019 selon ses composants \nsur ' + ds.LIBELLE,
      is3D: true,
      titleTextStyle: {
           color: theme_color,
        },
...
function chartProductionBesoinsLogements(ds, container) {
    ...
    },
    {
        ...
        y : [ds.P08_RSECOCC - ds.P08_RSECOCC + ds.P08_LOGVAC - ds.P08_LOGVAC,
             ...
             ds.P19_RSECOCC - ds.P08_RSECOCC + ds.P19_LOGVAC - ds.P08_LOGVAC],
    },
    {
        ...
        y : [ds.P08_RP - ds.P08_RP + ds.P08_RSECOCC - ds.P08_RSECOCC + ds.P08_LOGVAC - ds.P08_LOGVAC,
             ...
             ds.P19_RP - ds.P08_RP + ds.P19_RSECOCC - ds.P08_RSECOCC + ds.P19_LOGVAC - ds.P08_LOGVAC],
    },
  {
        ...
        y : [0, offset_construits ,
             ...
             offset_construits + ds.NB_LGT_TOT_COMMENCES_1316 + ds.NB_LGT_TOT_COMMENCES_17PL]
  },
  {
        ...
        x : [2019, 2020],
        y : [ds.P19_RP-ds.P08_RP+ds.P19_RSECOCC-ds.P08_RSECOCC+ds.P19_LOGVAC-ds.P08_LOGVAC ,
             ds.NOUV_LOG_0813+ds.NB_LGT_TOT_COMMENCES_1316+ds.NB_LGT_TOT_COMMENCES_17PL]
  },
  ];
...
/*
  {
  ...
  },
     {
            ...
            line: {shape: 'spline', dash: 'dot', width: 4, color : log_construits_color},
            x : [2020, 2021],
            y : [ds.NOUV_LOG_0813 + ds.NB_LGT_TOT_COMMENCES_1316 + ds.NB_LGT_TOT_COMMENCES_17PL,
                 ds.NOUV_LOG_0813 + ds.PROJ_LOG_REALISES_2021]
     },
*/

    if ((ds.SRU_CARENCE_2020 != 0 ) || ((ds.NB_LGT_PRET_LOC_SOCIAL_1316 + ds.NB_LGT_PRET_LOC_SOCIAL_17PL) != 0)) {
      ...
      data.push(
         {
            "Condition" : "(SRU_CARENCE_2020 != 0) or ((NB_LGT_PRET_LOC_SOCIAL_1316+ NB_LGT_PRET_LOC_SOCIAL_17PL) != 0)",
            ...
            y : [offset_sru ,
                 ...
                 offset_sru + ds.NB_LGT_PRET_LOC_SOCIAL_1316 + ds.NB_LGT_PRET_LOC_SOCIAL_17PL]
          })
    }
...
function chartRepartitionTypesLogements(ds, container) {
    // Répartition des types de Logements en 2019
    $('#'+container).html('');
    if (ds=== null) { return ; }

    var trace1 = {
      x: ["2008", "2013", "2019"],
      y: [ds.P08_RP, ds.P13_RP, ds.P19_RP],
    ...
    var trace2 = {
      x: ["2008", "2013", "2019"],
      y: [ds.P08_RSECOCC, ds.P13_RSECOCC, ds.P19_RSECOCC],
    ...
    var trace3 = {
      x: ["2008", "2013", "2019"],
      y: [ds.P08_LOGVAC, ds.P13_LOGVAC, ds.P19_LOGVAC],
      ...
      datasets: [
        ...
        },
        {
          ...
          data: [   ds.BESOIN_LOG_ANNUEL_0813 * 1 ,
                    ...
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 1 ,
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 2 ,
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 3 ,
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 4 ,
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 5 ,
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 5 + ds.BESOIN_LOG_ANNUEL_1920 * 1 ,
                    ds.BESOIN_LOG_ANNUEL_0813 * 3 + ds.BESOIN_LOG_ANNUEL_1319 * 5 + ds.BESOIN_LOG_ANNUEL_1920 * 2 ],
          hidden: true,
          fill: false,
          tension: 0.5,
      ...
      datasets: [
        {
          ...
          data: [ds.ART_NAF09ART10, ds.ART_NAF10ART11, ds.ART_NAF11ART12, ds.ART_NAF12ART13,
                 ...
                 ds.ART_NAF17ART18, ds.ART_NAF18ART19, ds.ART_NAF19ART20, ds.ART_NAF20ART21, ds.ART_NAF21ART22],
          fill: false,
          tension: 0.5,
          borderDash: [5, 5],
          borderColor: border_Color,
        ...
        },
        {
          ...
          data: [ ds.ART_NAF09ART10 ,
                  ...
                  ART1020 + ds.ART_NAF20ART21 + ds.ART_NAF21ART22 ],
          fill: false,
          tension: 0.5,
          borderColor: border_Color,
          backgroundColor: background_Color,
      ...
      datasets: [
        {
          ...
          data: [ds.ART_ART09HAB10, ds.ART_ART10HAB11, ds.ART_ART11HAB12, ds.ART_ART12HAB13,
                 ...
                 ds.ART_ART17HAB18, ds.ART_ART18HAB19, ds.ART_ART19HAB20, ds.ART_ART20HAB21, ds.ART_ART21HAB22],
          fill: false,
          tension: 0.5,
          borderDash: [5, 5],
          borderColor: border_Color,
        ...
        },
        {
          ...
          data: [ ds.ART_ART09HAB10 ,
                  ...
                  ART1020_LOG + ds.ART_ART20HAB21 + ds.ART_ART21HAB22],
          fill: false,
          tension: 0.5,
          borderColor: border_Color,
          backgroundColor: background_Color,
...
function chartAutorisationsConso(ds, container) {
    ...
    TOT16 = ds.CONSO_LOG_SUPERFICIE2013 + ds.CONSO_LOG_SUPERFICIE2014 + ds.CONSO_LOG_SUPERFICIE2015 + ds.CONSO_LOG_SUPERFICIE2016
    TOT19 = TOT16 + ds.CONSO_LOG_SUPERFICIE2017 + ds.CONSO_LOG_SUPERFICIE2018 + ds.CONSO_LOG_SUPERFICIE2019

    TOT16_TOT = ds.CONSO_LOG_SUPERFICIE2013_TOT + ds.CONSO_LOG_SUPERFICIE2014_TOT + ds.CONSO_LOG_SUPERFICIE2015_TOT + ds.CONSO_LOG_SUPERFICIE2016_TOT
    ...
    const data = {
      ...
      datasets: [
        ...
        },
        {
          ...
          data: [0,
                 f_round(ds.SCOT_OUEST_LOG_SUPERFICIE_2500/10000,1),
                 f_round(((((ds.SCOT_TRAJECTOIRE_2500_2030-ds.SCOT_OUEST_LOG_SUPERFICIE_2500)/3)*1)+ds.SCOT_OUEST_LOG_SUPERFICIE_2500)/10000,1),
                 f_round(((((ds.SCOT_TRAJECTOIRE_2500_2030-ds.SCOT_OUEST_LOG_SUPERFICIE_2500)/3)*2)+ds.SCOT_OUEST_LOG_SUPERFICIE_2500)/10000,1),
        ...
        },
        {
          ...
          data: [0,
                 ...
                 f_round(((((ds.SCOT_TRAJECTOIRE_ALL_2030-ds.SCOT_OUEST_LOG_SUPERFICIE_ALL)/3)*1)+ds.SCOT_OUEST_LOG_SUPERFICIE_ALL)/10000,1),
                 f_round(((((ds.SCOT_TRAJECTOIRE_ALL_2030-ds.SCOT_OUEST_LOG_SUPERFICIE_ALL)/3)*2)+ds.SCOT_OUEST_LOG_SUPERFICIE_ALL)/10000,1),
...
function chartFluxPopulation(ds, container) {
    ...
    const data = {
      ...
      datasets: [
        {
          label: "Flux Entrant",
          data: [ds.FLUX_2014_ENTRANT, ds.FLUX_2015_ENTRANT, ds.FLUX_2016_ENTRANT, ds.FLUX_2017_ENTRANT, ds.FLUX_2018_ENTRANT, ds.FLUX_2019_ENTRANT, ds.FLUX_2020_ENTRANT],
          fill: false,
          tension: 0.5,
        ...
        {
          label: "Flux Sortant",
          data: [ds.FLUX_2014_SORTANT, ds.FLUX_2015_SORTANT, ds.FLUX_2016_SORTANT, ds.FLUX_2017_SORTANT, ds.FLUX_2018_SORTANT, ds.FLUX_2019_SORTANT, ds.FLUX_2020_SORTANT],
          fill: false,
          tension: 0.5,
          borderColor: logements_color,
          backgroundColor: "#9370DB",
      ...
      datasets: [
        {
          ...
          data: [ds.TM_2008, ds.TM_2013, ds.TM_2019, , , , ],
          fill: false,
          tension: 0.5,
          borderColor: border_Color,
          backgroundColor: background_Color,
      ...
      datasets: [
        {
          ...
          data: [ds.P08_POP, ds.P13_POP, ds.P19_POP, , , , ],
          fill: false,
          tension: 0.5,
          borderColor: border_Color,
          backgroundColor: background_Color,
