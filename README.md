...
[Cet outil](https://github.com/bheuse/ConsommationFonciere) consolide les données qui permettent un diagnostic de Consommation Foncière en Region Sud : Provence - Alpes - Cote d'Azur.
...
En synergie avec le guide de la Sobriété Foncière et l'Urbascope, il vise à mettre en œuvre l'objectif ZAN - Zéro Artificialisation Nette.

### Versions
- _A venir V5 - Janvier 2023_ : Prise en compte des dernières projections Omphale de l'INSEE
- **V4 - Novembre 2022** : Prise en compte des dernières données INSEE, avec les séries de 2019 sur les communes
- **V3 - Octobre 2021** : Version Web
- **V2 - Septembre 2021** : Configuration du traitement des données - Diagnostics
- **V1 - Septembre 2021** : Traitement des données - Rapport HTML / Email

### Introduction

![img.png](input/Readme-Header.png)

![img.png](input/Readme-Body.png)

### Objectif Zéro Artificialisation Nette !

A l'horizon 2030, diviser au moins par deux le rythme d'artificialisation des espaces naturels, 
agricoles et forestiers, par rapport à la consommation d'espaces observée depuis 2010.

### La Loi Climat et Résilience
L'objectif ZAN en 2050 fixé dans le cadre du "plan biodiversité" de 2018 a été confirmé par le vote
...
des ouvertures à l’urbanisation permettra de répondre aux besoins en logements futurs.

### Le Guide de la Sobriété Foncière

[Le Guide de la Sobriété Foncière de France Nature Environnement PACA.](https://fnepaca.fr/wp-content/uploads/sites/5/2022/09/guide_Vers-la-sobriete-fonciere-2022_complet-2.pdf)

**Le Guide de la Sobriété Foncière** couvre une sélection d’enjeux et de leviers pour atteindre la sobriété foncière.
Il permet d’aborder, de manière pédagogique, les enjeux des politiques publiques en matière
de préservation des sols et la capacité à organiser la protection des ressources.
Son contenu est basé sur les publications scientifiques et la littérature grise,
sur les stratégies nationales et politiques publiques, sur les retours de terrain
d'associations, sur des entretiens avec les agences d’urbanisme et les institutions
et sur une étude de documents d’urbanisme de la région Paca.

### L'Urbascope

[L'Urbascope de France Nature Environnement PACA.](https://cloud.fne04.fr/s/yqMw6gq5dFJf37B)

**L'Urbascope** propose une méthodologie d'évaluation des besoins foncier à l'échelle d'un territoire.
Toujours en gestation, France Nature Environnement développe un « Urbascope », outil d’aide au 
positionnement sur les projets de document d’urbanisme. 
Composé d’un livret et d’une grille d’analyse, il vous permettra, en appui de ce
guide et des chiffres de ce site, de vous approprier les enjeux de la sobriété foncière
dans votre territoire.
 
### Consulter les données de votre territoire

[Le site Sobriété Foncière.](https://sobrietefonciere.fnepaca.fr)

**Le site Sobriété Foncière** vous permet de consulter les données historiques d'évolution de la population, des constructions
de logement, de l'artificialisation, des besoins en logements sociaux, consolidées sur votre territoire,
ainsi que les dernières projections de l'INSEE.

Il ne porte que sur le logement et ne traite pas du foncier destiné à des équipements ou à l'économie.

### Mettez votre territoire en accord avec l'objectif ZAN 
Un outil de test vous permet de tester différents scenario d'urbanisation pour atteindre votre objectif ZAN.
...
- Génération d'un Rapport de Données
...
_Les données Sitadel et INSEE pour les communes ne sont pas pré-téléchargées dans GitHub.
Ces données seront téléchargées a la premiere utilisation dans le répertoire "data"._
...
- "**Zones**" : Des listes des communes, hors zonage administratif (par exemple, zone littorale 06)
...
Si le Test renvoi VRAI, le Message est affiché.
...
### Rapport HTML
    ...
    Les rapports HTML ne sont plus maintenus. 
...
Les données ont été compilées manuellement à partir des PDF
...
Ces données ne sont pas pré-téléchargées dans GitHub - elles le seront à la premiere utilisation.
...
## HTML Dillinger Readme 

Visit [dillinger.io](https://dillinger.io) 
